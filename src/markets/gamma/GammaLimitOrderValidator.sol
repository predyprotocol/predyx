...
struct GammaLimitOrderValidationData {
 ...
 */
contract GammaLimitOrderValidator {
    ...
    function validate(GammaOrder memory gammaOrder, IPredyPool.TradeResult memory tradeResult) external pure {
        GammaLimitOrderValidationData memory validationData =
            abi.decode(gammaOrder.validationData, (GammaLimitOrderValidationData));
