...
library Perp {
    ...
    function updateRebalanceFeeGrowth(PairStatus memory _pairStatus, SqrtPerpAssetStatus storage _sqrtAssetStatus)
        internal
    {
    ...
    function settleUserBalance(PairStatus storage _pairStatus, UserStatus storage _userStatus)
        internal
        returns (bool)
    {
    ...
    function updatePosition(
        PairStatus storage _pairStatus,
    ...
    function updateRebalancePosition(PairStatus storage _pairStatus, int256 _updateAmount0, int256 _updateAmount1)
        internal
    {
